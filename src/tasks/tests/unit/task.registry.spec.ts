...
describe("taskRegistry", () => {
  ...
  describe("getTask", () => {
    ...
    it("should throw an ApiException if the task is not found", () => {
      expect(() => taskRegistry.getTask("non-existent-task")).toThrow(ApiException);
    });
  });
  ...
  describe("getParentSequenceId", () => {
    it("should retrieve the parent sequence ID of a registered task", () => {
      ...
      const parentSequenceId = taskRegistry.getParentSequenceId(taskDefinition.id);
